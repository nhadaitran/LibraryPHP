                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr role="row">
                                <td>11</td>
                                <td><a href="user/bookNoLogin.php">Software Engineering</a></td>
                                <td>ABCDEFF</td>
                                <td><button class="btn btn-danger btn-sm" disabled="disable">not available</button></td>
                            </tr>
                            <tr role="row">
                                <td>49</td>
                                <td><a href="user/bookNoLogin.php">Python Cookbook</a></td>
                                <td>ABCDEFF</td>
                                <td><button class="btn btn-success btn-sm" disabled="disable">available</button></td>
                            </tr>
                            <tr role="row">
                                <td>1</td>
                                <td><a href="user/bookNoLogin.php">Machinery Handbook</a></td>
                                <td>ABCDEFF</td>
                                <td><button class="btn btn-danger btn-sm" disabled="disable">not available</button></td>
                            </tr>
                            <tr role="row">
                                <td>20</td>
                                <td><a href="user/bookNoLogin.php">Effective C++</a></td>
                                <td>Scott Meyers</td>
                                <td><button class="btn btn-danger btn-sm" disabled="disable">not available</button></td>
                            </tr>
                            <tr role="row">
                                <td>220</td>
                                <td><a href="user/bookNoLogin.php">Java 2</a></td>
                                <td>Herbert </td>
                                <td><button class="btn btn-success btn-sm" disabled="disable">available</button></td>
                            </tr>
                            <tr role="row">
                                <td>35</td>
                                <td><a href="user/bookNoLogin.php">A Brief History of Time</a></td>
