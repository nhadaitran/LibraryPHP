                    ...
                    <form method="post" action="../Controller/ControllerUser.php">
                        <div class="form-group">
                            ...
                            <div class="position-relative has-icon-right">
                                <input type="text" name="username" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Username" required="required">
                        ...
                        <button type="submit" value="login" name="action" class="btn btn-light btn-block">Đăng Nhập</button>
                    </form>
                </div>
            </div>
